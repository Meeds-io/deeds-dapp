...
<template>
  <v-card class="mt-8" flat>
    <v-card-title class="py-0 px-0 justify-center flex-nowrap">
      <span class="col-12 col-lg-8 col-md-7 ps-0 ms-n2 text-sm-h2 display-2 font-weight-bold text-center text-md-start">{{ $t('meedToken') }}</span>
      <v-spacer />
      <v-img 
