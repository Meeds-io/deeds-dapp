    ...
    <template #content>
      ...
      <v-card-text class="d-flex flex-column flex-grow-1">
        <div class="d-flex align-center">
          <v-chip :color="step === 1 && 'primary' || 'primary lighten-2'"><span class="font-weight-bold">1</span></v-chip>
        ...
        <div class="d-flex align-center mt-4">
          <v-chip :color="step === 2 && 'primary' || 'primary lighten-2'"><span class="font-weight-bold">2</span></v-chip>
