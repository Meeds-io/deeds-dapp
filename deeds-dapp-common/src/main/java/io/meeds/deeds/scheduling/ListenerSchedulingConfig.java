...
public class ListenerSchedulingConfig {
  ...
  @Bean
  public ListenerEventTriggerTask listenerEventTriggerTask() {
    return new ListenerEventTriggerTask();
  }

  @Bean
  public ListenerEventCleanupTask listenerEventCleanupTask() {
    return new ListenerEventCleanupTask();
  }
